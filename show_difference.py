...
voxel_size = 0.05  # 3 cm (typisch 0.02–0.05)

# 1) Laden
pcd_ref = o3d.io.read_point_cloud(os.path.join(INPUT_DIR, args.source))
pcd_cur = o3d.io.read_point_cloud(os.path.join(INPUT_DIR, args.target))
